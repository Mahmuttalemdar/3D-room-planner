...
bool PlaneModel::load(const char* tex1, const char* tex2, const char* Mixmap)
{
...
Texture& PlaneModel::getGrass()
{
    return this->m_GrassTex;
}

Texture& PlaneModel::getSand()
{
    return this->m_SandTex;
}

Texture& PlaneModel::getMixmap()
{
    return this->m_Mixmap;
}